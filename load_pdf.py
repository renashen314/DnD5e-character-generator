...
def calculate_chunk_ids(chunks):
    ...
    for chunk in chunks:
        ...
        # since it's harder for FAISS to preserve metadata, save ids to a separated array and map to chunks
        # however, this method does not guarantee accurate mapping
        chunk_ids = []
